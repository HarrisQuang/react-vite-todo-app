...
const Form = () => {
    ...
    // Way 1:
    // const carBrandOptions = carBrands.map((carBrand, key) => {return (
        ...
        <>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <label>
                    ...
                    checked={state.isChecked} onChange={handleChange}/> 
                    Is Checked?
                </label>
                <br />
                <label>
                    <input type="radio" name="gender" value="male" 
                    checked={state.gender === "male"} onChange={handleChange}/>{" "}Male
                </label>
                <label>
                    <input type="radio" name="gender" value="female" 
                    checked={state.gender === "female"} onChange={handleChange}/>{" "}Female
                </label>
                <br />
                <label >
